...
class ImageCreater:
    ...
    def drawEllipse(self):
        ...
        cv2.ellipse(self.img, center, axes, self.ellipseAngle, self.ellipseStartAngle , self.ellipseEndAngle, color, self.ellipseLineThickness)
        return self.img
    ...
    cv2.setTrackbarPos(ellipseXName,trackbarName,width/2)
    cv2.setTrackbarPos(ellipseYName,trackbarName,height/2)
    cv2.setTrackbarPos(ellipseFirstAxisName,trackbarName,150)
    cv2.setTrackbarPos(ellipseSecondAxisName,trackbarName,150)
    cv2.setTrackbarPos(ellipseEndAngleName,trackbarName,360)
    cv2.setTrackbarPos(ellipseRedName,trackbarName,255)
    cv2.setTrackbarPos(ellipseLineThicknessName,trackbarName,5)
